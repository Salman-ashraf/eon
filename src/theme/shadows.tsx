...
const createCustomShadow = (theme: Theme, color: string) => {
  ...
  return {
    ...
    primary: `0px 12px 14px 0px ${(theme.palette.primary.main, 0.3)}`,
...
export default function customShadows(pmode: string, theme: Theme) {
  return pmode === "dark"
    ? createCustomShadow(theme, theme.palette.dark.main)
    : createCustomShadow(theme, theme.palette.grey[400]);
}
